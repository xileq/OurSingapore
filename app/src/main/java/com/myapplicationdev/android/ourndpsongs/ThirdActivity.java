...
public class ThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etSingers = (EditText) findViewById(R.id.etDesc);
        etYear = (EditText) findViewById(R.id.etSquare);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(ThirdActivity.this, "Invalid KM", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Are you sure you want to delete this island " + etTitle.getText().toString());
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Do no discard",null);
